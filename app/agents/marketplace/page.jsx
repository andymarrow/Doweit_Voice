...
import { FiSearch, FiFilter, FiShoppingCart, FiLock, FiGlobe, FiCheck, FiPlus, FiArrowRight } from 'react-icons/fi';
...
// Components
import CreateInterviewModal from '@/app/agents/recruiter/_components/CreateInterviewModal'; // Reuse this component
...
const MARKETPLACE_AGENTS = [
    ...
    {
        id: 'mk-2',
        title: 'McKinsey Case Study Bot',
        creator: 'ConsultingPro',
        description: 'Practice market sizing and profitability frameworks. Strict on math.',
        priceOwner: 600,
        priceTrain: 60,
        rating: 4.9,
        users: 850,
    ...
    },
    {
        ...
        creator: 'HR_Master',
        description: 'Master the STAR method. Handles all standard behavioral questions.',
        priceOwner: 200,
        priceTrain: 20,
        rating: 4.5,
        users: 3000,
    ...
    {
        id: 'mk-4',
        title: 'Python Data Science Drill',
        creator: 'DataWiz',
        description: 'Pandas, NumPy, and SQL optimization questions. Includes live coding challenges.',
        priceOwner: 350,
        priceTrain: 35,
        rating: 4.7,
        users: 920,
...
export default function MarketplacePage() {
    ...
    const [selectedAgent, setSelectedAgent] = useState(null); // For Buy Modal
    ...
    // This handler simulates creating a private training agent
    ...
    return (
        <div className="p-6 lg:p-8 space-y-8 pb-20  mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-gray-100 dark:border-gray-800 pb-6">
                ...
                {/* Primary CTA: Create Custom Agent */}
                <button 
            ...
            <CreateInterviewModal 
                ...
                mode="trainee" // Pass this prop to redirect to /agents/recruited
            />
        </div>
    );
}
...
function PurchaseModal({ isOpen, onClose, agent }) {
    ...
    const handlePurchase = (type) => {
        ...
        toast.success(`Agent added to your gym! (-${cost} tokens)`);
        onClose();
    };
            ...
            >
                ...
                <div className="p-8 space-y-4">
                    ...
                    <button 
                        ...
                        className={`w-full group flex items-center justify-between p-5 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all bg-white dark:bg-gray-900 hover:bg-cyan-50 dark:hover:bg-cyan-900/10 text-left shadow-sm hover:shadow-md`}
                    >
                    ...
                    <button 
                        ...
                        className={`w-full group flex items-center justify-between p-5 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-500 transition-all bg-white dark:bg-gray-900 hover:bg-purple-50 dark:hover:bg-purple-900/10 text-left shadow-sm hover:shadow-md`}
                    >
                        <div className="flex items-center">
