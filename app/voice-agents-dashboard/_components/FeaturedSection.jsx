...
const featuredAgents = [
	{
		...
		description: "Automated support interactions.",
		href: "#",
	},
	{
		id: 2,
	...
	},
	{
		...
		description: "Create unique narratives with AI.",
		href: "#",
	},
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{featuredAgents.map((agent) => (
					...
					>
						...
						<a
							href={agent.href}
							className={`text-sm font-semibold ${accentTextClasses} hover:underline`}
						>
							Learn More →
						</a>
					</motion.div>
