...
function Header() {
	...
	return (
		...
		>
			...
			<div
				className="container mx-auto flex items-center justify-between backdrop-filter backdrop-blur-lg bg-opacity-70 dark:bg-opacity-70 rounded-full px-6 py-3 border border-opacity-30 dark:border-opacity-30 transition-colors duration-300 ease-in-out
                  bg-white dark:bg-purple-900 border-gray-200 dark:border-purple-700"
			>
				{/* Logo */}
				<Link
					href="/"
					className="flex items-center space-x-2 text-lg font-bold text-gray-800 dark:text-white transition-colors duration-300 ease-in-out"
				>
				...
				<div className="hidden lg:flex items-center space-x-4">
					...
					<div className="flex items-center bg-gray-100 dark:bg-purple-800 rounded-full px-3 py-1 lg:px-5 lg:py-3 transition-colors duration-300 ease-in-out">
						{" "}
						{/* Adjusted padding slightly for height */}
						<Search
							size={18}
			...
			<div
				className={`lg:hidden absolute top-full left-0 right-0 backdrop-filter backdrop-blur-lg bg-opacity-70 dark:bg-opacity-70 shadow-lg overflow-hidden transition-all duration-300 ease-in-out
			...
			>
				...
				{/* Separator */}
				<hr className="w-full border-gray-200 dark:border-gray-700 my-4 px-4" />{" "}
				{/* Added margin and px */}
				{/* Mobile Actions (Search, Settings - Stacked Vertically) */}
				<div className="flex flex-col space-y-4 px-4 items-start">
					{" "}
					{/* Added px-4 and items-start */}
					{/* Search Input and Icon */}
					{/* Use w-full so it takes the full width in the mobile menu */}
					<div className="flex items-center bg-gray-100 dark:bg-purple-800 rounded-full px-3 py-2 transition-colors duration-300 ease-in-out w-full">
						{" "}
						{/* Adjusted padding/py */}
						<Search
							size={18}
