...
const exploreAgentData = [
    {
        ...
        name: 'Alinax #012',
        description: 'Alina - our most famous And Successful. Real state call agent out in the market.',
    ...
    },
    {
        ...
        type: 'Call Agent', // Category
         badge: 'CR', // Badge
        name: 'Selxj #009',
        description: 'Selxj - A Call agent in taking appointments in the field of Clinic receptions.',
    ...
    },
     {
        ...
        type: 'Character', // Category
         badge: 'CH', // Badge
        name: 'Zaras #028',
        description: 'Zaras - a scifi character thats gotten very deep voice, talks about all the space adventures he had before the chats.',
    ...
    },
     {
        ...
        type: 'Character',
         badge: 'CH',
        name: 'Mystic #045',
        description: 'Mystic - A wise old sage with tales from ancient times, ready to share forgotten lore.',
    ...
    },
     {
        ...
        type: 'Recruiter',
         badge: 'CR',
        name: 'HireBot #011',
        description: 'HireBot - Streamlines your hiring process by conducting initial candidate screenings.',
    ...
    },
     {
        ...
        name: 'Narrator #007',
        description: 'Narrator - Brings your favorite stories to life with expressive and engaging narration.',
    ...
    // Add more agents as needed to fill out the grid and test filtering
    {
        ...
        type: 'Call Agent',
         badge: 'CR',
        name: 'Support #021',
        description: 'Support - Handles customer inquiries and provides instant assistance.',
    ...
    },
    {
        ...
        type: 'Character',
         badge: 'CH',
        name: 'Cyberpunk #084',
        description: 'Cyberpunk - A gritty inhabitant of the future city, full of street wisdom.',
    ...
    },
     {
        ...
        type: 'Recruiter',
         badge: 'CR',
        name: 'SkillFind #003',
        description: 'SkillFind - Matches candidates to job openings based on their skills and experience.',
    ...
    },
     {
        ...
        description: 'Storyteller - Crafts and reads original short stories across various genres.',
        imagePath: '/voiceagents/5.jpg', // Replace
...
const categories = ['All Agents', ...new Set(exploreAgentData.map(agent => agent.type))];
...
function Exploreagents() {
    ...
    const titleHighlightColor = theme === 'dark' ? 'text-purple-500' : 'text-cyan-500'; // Highlight color opposite of Popular
    const filterButtonInactiveBg = theme === 'dark' ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-200 hover:bg-gray-300';
    const filterButtonInactiveText = theme === 'dark' ? 'text-gray-400' : 'text-gray-700';
     const filterButtonActiveBg = theme === 'dark' ? 'bg-cyan-600' : 'bg-purple-600'; // Active button matches accent
    ...
    const cardBg = theme === 'dark' ? 'bg-gray-800' : 'bg-white'; // Card background
     ...
     const cardShadow = theme === 'dark' ? 'shadow-lg shadow-cyan-500/10' : 'shadow-lg shadow-purple-500/10'; // Subtle shadow
    ...
    const cardDescriptionColor = theme === 'dark' ? 'text-gray-300' : 'text-gray-300';
                        ...
                        {filteredAgents.map((agent) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 p-7 z-20 flex flex-col justify-end">
                                    ...
                                    {/* Top Left Badge */}
                                    <div className={`absolute top-4 left-4 text-xs font-bold px-3 py-1 rounded-full ${cardBadgeBg} ${cardBadgeText} z-30`}>
                                        {agent.badge}
                                    </div>

                                     {/* Bottom Right Stat (Small Avatar + Count) */}
                                    <div className="absolute   bottom-4 right-4 flex items-center z-30">
                                         <div className="relative w-6 h-6 rounded-full overflow-hidden border border-white mr-1"> {/* Adjust size/border */}
                                             {agent.statIcon && (
                                                 <Image
                                                     src={agent.statIcon}
                                                     alt="Stat Icon"
                                    ...
                                    {/* Agent Name */}
                                    <h3 className={`text-xl font-bold mb-1 ${cardNameColor} text-shadow-sm`}>
                                        {agent.name}
                                    </h3>

                                    {/* Agent Description */}
                                    <p className={`text-sm mb-4 ${cardDescriptionColor} text-shadow-sm`}>
                                        {agent.description}
                                    </p>
