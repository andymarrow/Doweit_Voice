...
import { RecentChatProvider } from "./_context/RecentChatContext";
			...
			<ThemeProvider attribute="class" defaultTheme="dark">
				...
				<RecentChatProvider>
					<div className="flex h-screen overflow-hidden">
						...
						>
							{children}{" "}
							{/* This is where your page.jsx content will be rendered */}
						</motion.main>
					</div>
				</RecentChatProvider>
				{/* Floating Help Button - UI element, no backend changes needed here */}
				<button
					className={`fixed bottom-6 right-6 flex items-center text-white text-sm font-semibold px-4 py-3 rounded-full shadow-lg transition-all z-50
