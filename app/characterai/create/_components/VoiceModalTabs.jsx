...
function VoiceModalTabs({ activeTab, onTabChange, tabs }) { // Added tabs prop
    ...
    return (
        <div className={`flex border-b ${uiColors.borderPrimary} -mb-[1px]`}> {/* Add negative margin to prevent double border */}
                ...
                return (
                     <button
                         ...
                         disabled={isDisabled} // Disable the button itself
                          className={`flex-1 text-center px-4 py-2 text-sm font-medium transition-colors border-b-2 -mb-[2px] // Offset border
                                       ${isActive
