...
function VoiceItem({ voice, isSelected, onSelectVoice, onPlayVoice, isPlaying }) { // Removed audioRef
    // Removed audioRef and internal playback state/effects

    // Handle play/pause logic for THIS voice item - delegates to parent
    const handlePlayClick = (e) => { // Removed type
        e.stopPropagation();
        if (isPlaying) {
             onPlayVoice(null);
        } else {
    ...
    return (
        ...
        >
            ...
            <div className="flex-grow">
                <div className={`font-semibold text-md ${uiColors.textPrimary}`}>{voice.name}</div>
