...
const createKnowledgeBase = async (newKbData) => {
    console.log("[KnowledgeBasePage] Calling POST /api/knowledgebases with data:", newKbData);
...
export default function KnowledgeBasePage() {
    ...
    const handleCreateNewKnowledgeBase = async (newKbData) => {
        console.log("[KnowledgeBasePage] Initiating KB creation via API...", newKbData);
    ...
    return (
        <div className="flex flex-col space-y-6 w-full h-full">
            ...
            {fetchError && ( // Display fetch or create error message
                  <div className={`mb-4 p-3 rounded-md ${uiColors.alertDangerBg} ${uiColors.alertDangerText} text-sm`} role="alert">
