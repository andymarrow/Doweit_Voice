...
import { FiX, FiPhoneIncoming, FiPhoneOutgoing, FiEdit } from 'react-icons/fi';
    ...
    return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            <div className={`${uiAccentClasses.bgPrimary} rounded-lg shadow-xl p-6 w-full max-w-2xl relative`}>
                ...
                {/* Cards Grid */}
                <div className={`grid gap-4 mb-6 ${currentCards.length >= 2 ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
