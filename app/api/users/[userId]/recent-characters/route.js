...
import { eq, desc, sql, distinct, inArray } from "drizzle-orm"; // Import necessary helpers
...
export async function GET(req, { params }) {
	...
	try {
		...
		const recentCharacters = await db.query.characters.findMany({
			where: inArray(characters.id, uniqueCharacterIds), // Use SQL IN clause with the list of IDs
