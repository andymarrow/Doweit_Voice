...
export const voices = pgTable('voices', {
    ...
    creatorId: varchar('creator_id', { length: 256 }).references(() => users.id, { onDelete: 'cascade' }),
    ...
    unqUserProviderVoice: uniqueIndex('user_provider_voice_unq').on(t.creatorId, t.provider, t.providerVoiceId),
}));
